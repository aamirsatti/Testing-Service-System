                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    ?>    
                                        <tr class="<?php if($counter%2 == 0) echo 'odd gradeX';?>">
                                            ...
                                            <td><a href="<?php echo Yii::app()->createurl('admin/reviewer/profile/id/'.base64_encode($rec->id));?>" title="Edit"> <?php echo $rec->first_name; ?></a></td>
                                            <td><?php echo  ProductReviewer::model()->count('reviewer_id=:id AND status=:status', array(':id' => $rec->id, ':status' => 1));//isset($rec->productReviewers) ? count($rec->productReviewers) : 0; ?></td>
                                            <td><?php echo $rec->email; ?></td>
                                            <td><a href="<?php echo Yii::app()->createurl('admin/reviewer/profile/id/'.base64_encode($rec->id));?>" target="_blank">View Profile</a></td>
                                            <td class="center" >
                                                <a href="<?php echo Yii::app()->createurl('admin/reviewer/profile/id/'.base64_encode($rec->id));?>" title="Edit"> <i class="fa fa-pencil"></i></a> | 
                                                <a href="javascript:void(0);" onclick="product_del('<?php echo Yii::app()->createurl('admin/reviewer/delete/id/'.base64_encode($rec->id));?>');" title="Delete" data-toggle="modal" data-target="#myModal"> <i class="fa fa-times"></i></a>
                                            </td>
                                        </tr>
                                    <?php  $counter++;
                                    }
