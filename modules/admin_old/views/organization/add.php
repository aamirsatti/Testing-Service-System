                                ...
                                <div class="col-md-8">
                                    ...
                                    <form role="form" method="post" enctype="multipart/form-data">        
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="dep_title" id="title" required value="<?php echo isset($rec->OrgName) ? $rec->OrgName : ''; ?>"/>
                                            <sapn class="help-block" id="title_error"></sapn>
                                        </div>
                                        <div class="form-group">
                                            <label>Organization Type</label> 
                                            <select class="form-control" name="dep_type">
                                              <option value="Public" <?php if(isset($rec->org_type) && $rec->org_type == 'Public') echo 'selected'; ?>>Public</option>
                                              <option value="Private" <?php if(isset($rec->org_type) && $rec->org_type == 'Private') echo 'selected'; ?>>Private</option>
                                              <option value="Non-Profit" <?php if(isset($rec->org_type) && $rec->org_type == 'Non-Profit') echo 'selected'; ?>>Non-Profit</option>
                                            </select>  
                                            <sapn class="help-block" id="subject_error"></sapn>
                                        </div>
                                        <div class="form-group" style="display:none;">
                                            <label>Description</label>
                                            <textarea class="form-control" id="body" rows="8" cols="10" name="dep_detail"><?php //echo isset($rec->test_detail) ? str_replace(array("<br />"),"",$data->test_detail) : ''; ?></textarea>   
                                            <?php
