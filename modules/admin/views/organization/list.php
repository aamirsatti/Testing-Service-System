                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    ?>    
                                        <tr class="<?php if($counter%2 == 0) echo 'odd gradeX';?>">
                                            ...
                                            <td><?php echo isset($rec->OrgName) ? $rec->OrgName : ''; ?></td>
                                            <td><?php echo isset($rec->org_type) ? $rec->org_type : ''; ?></td>
                                            <td><?php echo isset($rec->posts) ? count($rec->posts) : ''; ?></td>
                                            
                                            <td class="center" >
                                                <a href="<?php echo Yii::app()->createurl('admin/organization/edit/id/'.base64_encode($rec->OrgID));?>" title="Edit"> <i class="fa fa-pencil"></i></a> | 
                                                <a href="javascript:void(0);" onclick="product_del('<?php echo Yii::app()->createurl('admin/organization/delete/id/'.base64_encode($rec->OrgID));?>');" title="Delete" data-toggle="modal" data-target="#myModal"> <i class="fa fa-times"></i></a></td>
