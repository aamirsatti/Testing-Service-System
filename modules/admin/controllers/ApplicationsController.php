...
class ApplicationsController extends Controller
{
	...
	// delete Application
	public function actiondelete_app($id)
	{
		if(isset($id) && $id != '')
		{
			Pstcandloctestcentr::model()->deleteall('PCLTCID=:id', array(':id' => base64_decode($id)));
			Yii::app()->session['success'] = 'Application deleted successfully';
			$this->redirect(array('applications/index'));		
		}
		else
		   $this->redirect(array('applications/index'));
