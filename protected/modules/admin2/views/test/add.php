...
<tr>
	...
	<td>
		...
		<tr>
		<th valign="top">Test date:</th>
		<td class="noheight">
		   <input type="date" class="inp-form" name="test_date" required/>
			<?php /*?><table border="0" cellpadding="0" cellspacing="0">
			<tr  valign="top">
				<td>
				
				
				<select id="d" class="styledselect-day" name="test_date_d" required>
				...
				<td>
					<select id="m" class="styledselect-month" name="test_date_m" required>
				...
				<td>
					<select  id="y"  class="styledselect-year" name="test_date_y" required>
				...
				<td><a href=""  id="date-pick"><img src="<?php echo Yii::app()->request->baseurl;?>/resources/admin/images/forms/icon_calendar.jpg"   alt="" /></a></td>
			</tr>
			</table><?php */?>
        ...
        <tr>
            ...
            <td><textarea rows="" cols="" class="form-textarea" name="test_detail" required></textarea></td>
            <td></td>
        </tr>
        <tr>
            <th valign="top">Test Fee:</th>
            <td><input type="text" class="inp-form" name="test_fee" required/></td>
            <td></td>
        </tr>
        <tr>
		<th valign="top">Last date for apply:</th>  
		<td class="noheight">
		
			<input type="date" class="inp-form" name="last_date_apply" required/>
			<?php /*?><table border="0" cellpadding="0" cellspacing="0">
			<tr  valign="top">
				<td>
				
				
				<select id="d" class="styledselect-day" name="last_date_d" required>
					<option value="">dd</option>
					<option value="1">1</option>
					<option value="2">2</option>
					<option value="3">3</option>
				...
				<td>
					<select id="m" class="styledselect-month" name="last_date_m" required>
						<option value="">mmm</option>
						<option value="1">Jan</option>
						<option value="2">Feb</option>
						<option value="3">Mar</option>
				...
				<td>
					<select  id="y"  class="styledselect-year" name="last_date_y" required>
						<option value="">yyyy</option>
						<?php $i = 2015;
						while($i <= 2020){ ?>
							<option value="<?php echo $i; ?>"><?php echo $i; ?></option>
        ...
        <tr>
        <th>Upload Application Form.</th>
        <td><input type="file" name="test_form" /></td>
        <td>
        <div class="bubble-left"></div>
        <div class="bubble-inner">Upload Application Form, Docx, Pdf or Image</div>
