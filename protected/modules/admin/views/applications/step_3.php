                                ...
                                <div class="col-md-8">
                                    ...
                                    <form role="form" method="post" id="personal_info_form" onsubmit="return check_validation()" enctype="multipart/form-data">        
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="radio" name="bank_slip"   <?php if(isset($post_cand->bank_slip) && $post_cand->bank_slip ==  1) echo 'checked'; ?> value="1"> Yes
                                            &nbsp;&nbsp;<input type="radio" name="bank_slip" <?php if(isset($post_cand->bank_slip) && $post_cand->bank_slip ==  0) echo 'checked'; ?> value="0"> No
                                            <sapn class="help-block" id="cnic_error"></sapn>
                                        </div>
                                        <div class="form-group">
                                            <label>Application Status</label><br/>
                                            <input type="radio" name="status"   <?php if(isset($post_cand->status) && $post_cand->status ==  1) echo 'checked'; ?> value="1"> Completed
                                            &nbsp;&nbsp;<input type="radio" name="status" <?php if(isset($post_cand->status) && $post_cand->status ==  0) echo 'checked'; ?> value="0"> Pending
                                        ...
                                        <?php if(Yii::app()->request->getParam('PCLTC')){ ?>
