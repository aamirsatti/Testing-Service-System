        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <!-- Test Schedule -->
                    <li <?php if(Yii::app()->controller->action->id == 'applications') { ?> class="active" <?php } ?>>
                        <a <?php if(Yii::app()->controller->id == 'applications') { ?> class="active-menu" <?php } ?> href="#"><i class="fa fa-file fa-3x"></i> Test Schedule<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo yii::app()->createurl('admin/test/schedule_test');?>">View All</a>
                            </li>
                            <li>
                                <a href="<?php echo yii::app()->createurl('admin/applications/add');?>">Add Application</a>
                            </li>
