 ...
 function edit_cert(val, counter)
 {
  ...
  <div class="row">
      ...
      <div class="col-md-12" id="profile">
        <h2>Your Profile<small style="float:right;"><input type="button"  class="btn btn-primary" onclick="edit_profile(1)" value="Edit"></small></h2>
			<hr class="colorgraph">
    ...
    <div class="col-md-12" id="edit_profile" style="display:none;">
    	<form role="form" method="post" enctype="multipart/form-data" action="<?php echo Yii::app()->createurl('user/site/Update_profile'); ?>">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
						...
						<input type="date" name="dob" id="email" class="form-control input-lg" placeholder="Date of Birth" tabindex="4">
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
  ...
  <div class="row">
			  ...
			  foreach($user_data->academicinfos as $rec) { ?>
                  ...
                  <tr><td colspan="7"><hr />
                         <div class="col-md-12" id="edit_education_<?php echo $counter; ?>" style="display:none;">
                                <form role="form" method="post" enctype="multipart/form-data" action="<?php echo Yii::app()->createurl('user/site/update_academic'); ?>">
    ...
    <div class="col-md-12" id="edit_education" style="display:none;">
    	<form role="form" method="post" enctype="multipart/form-data" action="<?php echo Yii::app()->createurl('user/site/update_academic'); ?>">
			<h2>Add Educational Record<small></small></h2>
			<hr class="colorgraph">
  ...
  <div class="row">
			  ...
			  foreach($user_data->certificatedetails as $rec) { ?>
                  ...
                  <tr><td colspan="7"><hr />
                         <div class="col-md-12" id="edit_cert_<?php echo $counter; ?>" style="display:none;">
                                <form role="form" method="post" enctype="multipart/form-data" action="<?php echo Yii::app()->createurl('user/site/update_certificate'); ?>">
    ...
    <div class="col-md-12" id="edit_cert" style="display:none;">
    	<form role="form" method="post" enctype="multipart/form-data" action="<?php echo Yii::app()->createurl('user/site/update_certificate'); ?>">
			<h2>Add Certification Record<small></small></h2>
			<hr class="colorgraph">
