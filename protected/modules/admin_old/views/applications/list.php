                                        ...
                                        <tr class="<?php if($counter%2 == 0) echo 'odd gradeX';?>">
                                            ...
                                            <td class="center" >
                                               <a href="<?php echo Yii::app()->createurl('admin/applications/step_3/PCLTC/'.base64_encode($rec->PCLTCID));?>" title="Edit"> <i class="fa fa-pencil"></i></a> | 
                                                <a href="javascript:void(0);" onclick="product_del('<?php echo Yii::app()->createurl('admin/test/delete/id/'.base64_encode($rec->PCLTCID));?>');" title="Delete" data-toggle="modal" data-target="#myModal"> <i class="fa fa-times"></i></a></td>
