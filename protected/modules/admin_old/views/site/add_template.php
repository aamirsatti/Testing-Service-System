                                ...
                                <div class="col-md-8">
                                    ...
                                    <form role="form" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="title" id="title" value="<?php echo isset($template->title) ? $template->title : ''; ?>"/>
                                        ...
                                        <button type="submit" class="btn btn-default" onclick="return email_templates()">Update</button>
